...
# claude code aliases
alias claude="claude --dangerously-skip-permissions --agent daily --verbose"

mc() {
  pushd ~/work/claude >/dev/null || return
  claude --dangerously-skip-permissions --agent daily --verbose
  popd >/dev/null
}
