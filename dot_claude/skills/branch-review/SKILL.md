...
description: Thorough code review of branch changes compared to main with user approval before applying fixes. Use when user says "/branch-review", "review this branch", "review branch changes", or wants a code review of all commits on the current branch before creating a PR.
---

# Claude Branch Review

Thorough code review of all commits on the current branch compared to main, with user confirmation before making any changes.
...
Apply the standard review criteria from `../../prompts/review-criteria.md` (all 9 categories including Architecture and Commit Hygiene). See that file for the full checklist, severity levels, and output format.
