---
name: jira
description: Install, configure, and use Jira CLI for issue tracking. Use when working with Jira issues, viewing tickets, creating tasks, setting up the CLI, or any Jira operations. Triggers on "jira issue", "view ticket", "create task", "jira setup", or Jira CLI questions.
allowed-tools:
  - Bash(jira:*)
  - Read
---
