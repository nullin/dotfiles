# Go Review Detailed Patterns

Before/after examples for each checklist item, derived from code reviews by zachspar and lsiv568 in the cw-eng-cli repository.

## Table of Contents

1. [Constants and Standard Library Usage](#1-constants-and-standard-library-usage)
2. [Error Handling](#2-error-handling)
3. [Return Values: Pointer vs Value](#3-return-values-pointer-vs-value)
4. [Boolean and Zero Values](#4-boolean-and-zero-values)
5. [Encapsulation and API Design](#5-encapsulation-and-api-design)
6. [Code Organization and DRY](#6-code-organization-and-dry)
7. [Cobra CLI Patterns](#7-cobra-cli-patterns)
8. [Type Design](#8-type-design)
9. [Testing and Maintainability](#9-testing-and-maintainability)
10. [Code Maintenance](#10-code-maintenance)
...
Don't build features for hypothetical future requirements. Implement what's needed now, with clean abstractions that make future changes easier.
...
Use `make imports` to organize and format imports automatically.
