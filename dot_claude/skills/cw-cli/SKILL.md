---
name: cw-cli
description: CoreWeave Engineering CLI (cw) quick reference for common commands, authentication, and configuration. Use when running cw commands, checking CLI version, troubleshooting auth, clearing cache, or needing a quick lookup of which cw subcommand to use. Triggers on "cw cli", "cw command", "cw version", "cw update", or general CoreWeave CLI questions. For detailed help on specific subcommands, use the dedicated skills listed below.
allowed-tools:
  - Bash(cw:*)
  - Read
---
