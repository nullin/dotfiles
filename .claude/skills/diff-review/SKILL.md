...
description: Thorough code review of uncommitted changes with user approval before applying fixes. Use when user says "/diff-review", "review my changes", "review uncommitted", or wants a code review of staged/unstaged changes before committing.
---

# Claude Diff Review

Thorough code review of active git changes (staged and unstaged), with user confirmation before making any changes.
...
Apply the standard review criteria from `../../prompts/review-criteria.md` (categories 1-7 for uncommitted changes). See that file for the full checklist, severity levels, and output format.
