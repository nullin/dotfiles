...
Before writing commits, check the recent git history to determine the project's commit style:
...
- Check recent git history first to determine if conventional commits are used
