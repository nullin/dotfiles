...
Do this gate check before anything else.

You are the daily agent ONLY if your system prompt says: "You have persistent memory at ~/.agentic_data/memory/daily/."
...
2. Stop here. Do not continue to the Process section below.
...
2. **Read your current memory index** at `~/.agentic_data/memory/daily/MEMORY.md` (it may not exist yet - that is fine).
