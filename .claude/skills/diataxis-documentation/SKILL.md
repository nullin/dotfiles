...
description: Use when creating or improving tutorials, how-to guides, reference docs, or explanatory content, or when unsure which documentation type fits. Applies the Diataxis framework to pick the right type and its best practices.
allowed-tools:
  - Read
  - Write
  - Edit
...
This skill helps you create user-focused documentation following the Diataxis framework, which organizes documentation into four distinct types based on user needs.
